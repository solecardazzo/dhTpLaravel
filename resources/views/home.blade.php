...
<div class="row marketing">
 <div class="col-lg-4">
   ...
   <p><a class="btn btn-secondary" href="/eventos" role="button">Conoce más </a></p>
 </div><!-- /.col-lg-4 -->
 <div class="col-lg-4">
   ...
   <p><a class="btn btn-secondary" href="/preguntasFrecuentes" role="button">Conoce más </a></p>
 </div><!-- /.col-lg-4 -->
 <div class="col-lg-4">
   ...
   <p><a class="btn btn-secondary" href="/agradecimientos" role="button">Conoce más </a></p>
 </div><!-- /.col-lg-4 -->
</div><!-- /.row -->
@endsection
